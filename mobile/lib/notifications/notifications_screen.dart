...
class _View extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new_rounded, color: Colors.black, size: 22.w),
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.check_circle_outline_rounded, color: Colors.blue, size: 26.w),
            onPressed: () async {
              try {
                await context.read<NotificationsController>().markAllReadPermanent();
        ...
        child: Column(
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _tab("All", ctrl.selectedTab == "All", () => ctrl.changeTab("All")),
                  SizedBox(width: 12.w),
                  _tab("Unread (${ctrl.unreadCount})", ctrl.selectedTab == "Unread", () => ctrl.changeTab("Unread")),
                  SizedBox(width: 12.w),
                  _tab("Orders", ctrl.selectedTab == "Orders", () => ctrl.changeTab("Orders")),
                  SizedBox(width: 12.w),
                  _tab("System", ctrl.selectedTab == "System", () => ctrl.changeTab("System")),
                ],
              ),
            ),
            ...
            Expanded(
              child: ctrl.notifications.isEmpty
                ...
                children: [
                  ...
                  Icon(Icons.notifications_off, size: 80.w, color: Colors.grey[400]),
                  SizedBox(height: 16.h),
                  Center(
                    child: Text(
                  ...
                  Center(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 13.sp, color: Colors.grey[500]),
                    ),
                  ),
                ],
              )
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: selected
              ? [BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 8, offset: Offset(0, 3.h))]
              : [],
        ),
        child: Text(
          label,
  ...
  Widget _tile(BuildContext context, AppNotification n, NotificationsController ctrl) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16.r),
          boxShadow: [
            BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 10, offset: Offset(0, 4.h)),
          ],
        ),
        child: Row(
  ...
  void _openDetailSheet(BuildContext context, AppNotification n) {
    showModalBottomSheet(
      ...
      builder: (_) {
        final formatted = DateFormat('MMM dd, yyyy • h:mm a').format(n.createdAt.toLocal());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(formatted, style: GoogleFonts.poppins(color: Colors.grey[600], fontSize: 12)),
                  const SizedBox(height: 14),
                  Text(n.message, style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[800])),
                  const SizedBox(height: 18),
                  Align(
                    alignment: Alignment.centerRight,
                    child: TextButton(
                      onPressed: () => Navigator.pop(context),
                      child: Text("Close", style: GoogleFonts.poppins(color: Colors.blue, fontWeight: FontWeight.w600)),
                    ),
                  )
                ],
              ),
