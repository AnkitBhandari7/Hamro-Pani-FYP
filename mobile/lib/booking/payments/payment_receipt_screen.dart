      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            Text('Thank you for your purchase!', style: GoogleFonts.poppins(fontSize: 15.sp, color: Colors.grey[700])),

            SizedBox(height: 32.h),

            Text(
              'NPR ${receipt.amount.toStringAsFixed(0)}',
              style: GoogleFonts.poppins(fontSize: 40.sp, fontWeight: FontWeight.w800, color: Colors.blue[700]),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Download PDF", style: GoogleFonts.poppins(fontSize: 16.sp, fontWeight: FontWeight.w600)),
                  SizedBox(height: 4.h),
                  Text("Save a copy for your records.", style: GoogleFonts.poppins(fontSize: 13.sp, color: Colors.grey[600])),
                    ...
                    child: OutlinedButton.icon(
                      onPressed: ctrl.isSaving
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text("Receipt saved: $result")),
                          );
                        } catch (e) {
                          if (!context.mounted) return;
                          ScaffoldMessenger.of(context).showSnackBar(
                      ...
                      label: Text("Download Receipt", style: GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.w600)),
  ...
  Widget _receiptRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: GoogleFonts.poppins(fontSize: 14.sp, color: Colors.grey[700])),
          Flexible(
            child: Text(
              value,
