...
import 'my_bookings_history_controller.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                ...
                child: Icon(Icons.water_drop_rounded, color: Colors.blue, size: 28.w),
              ),
              SizedBox(width: 12.w),
              Expanded(
                child: Text(
          ...
          SizedBox(height: 8.h),
          Text(b.location, style: GoogleFonts.poppins(fontSize: 14.sp, color: Colors.grey[700])),
          SizedBox(height: 12.h),
          Row(
            children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 6.w),
              Text("${b.liters} Liters", style: GoogleFonts.poppins(fontSize: 13.sp, color: Colors.grey[800])),
              const Spacer(),
              if (b.price != null)
                Text(
                  "NRs. ${b.price}",
                  style: GoogleFonts.poppins(fontSize: 14.sp, fontWeight: FontWeight.w600, color: Colors.blue),
                ),
            ],
          ),
          SizedBox(height: 16.h),
          Row(
            ...
            children: [
              TextButton(
                ...
                child: Text("View Details", style: GoogleFonts.poppins(color: Colors.blue, fontWeight: FontWeight.w600)),
              ),
              if (b.canRebook)
                TextButton.icon(
                  onPressed: () {
                  ...
                  icon: Icon(Icons.refresh_rounded, size: 18.w, color: Colors.blue),
                  label: Text("Re-book", style: GoogleFonts.poppins(color: Colors.blue, fontWeight: FontWeight.w600)),
                ),
            ],
          ),
        ],
