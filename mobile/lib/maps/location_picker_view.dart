...
import 'search/nominatim_search_service.dart';
...
class _LocationPickerViewState extends State<LocationPickerView> {
  ...
  void initState() {
    super.initState();
    _center = widget.initial ?? const LatLng(27.7172, 85.3240); // Kathmandu fallback
  ...
  Future<void> _goToMyLocation() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("My location failed: $e"), backgroundColor: Colors.red),
      );
    } finally {
          ...
          IgnorePointer(
            child: Center(
              child: Padding(
                ...
                child: Icon(Icons.location_pin, size: 56, color: Colors.red[700]),
              ),
            ),
          ),
