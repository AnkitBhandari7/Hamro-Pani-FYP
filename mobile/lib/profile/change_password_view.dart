...
class _ChangePasswordViewState extends State<ChangePasswordView> {
  ...
  Future<void> _changePassword() async {
    ...
    if (!_isEmailPasswordUser(user)) {
      _snack("Password change is only available for Email/Password accounts.", isError: true);
      return;
    }
          ...
          child: Column(
            children: [
              TextField(
                controller: _current,
                obscureText: _ob1,
                decoration: _dec("Current Password", _ob1, () => setState(() => _ob1 = !_ob1)),
              ),
              const SizedBox(height: 12),
              TextField(
                controller: _newPass,
                obscureText: _ob2,
                decoration: _dec("New Password", _ob2, () => setState(() => _ob2 = !_ob2)),
              ),
              const SizedBox(height: 12),
              TextField(
                controller: _confirm,
                obscureText: _ob3,
                decoration: _dec("Confirm New Password", _ob3, () => setState(() => _ob3 = !_ob3)),
              ),
