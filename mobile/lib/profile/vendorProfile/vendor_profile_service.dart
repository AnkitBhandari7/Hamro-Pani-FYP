...
class VendorProfileService {
  ...
  static Future<Map<String, dynamic>> fetchVendorProfile(String token) async {
    ...
    throw Exception('Failed to load vendor profile: ${res.statusCode} - ${res.body}');
  }

  static Future<void> updateVendorProfile(String token, Map<String, dynamic> data) async {
