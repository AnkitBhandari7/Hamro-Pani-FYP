...
class WardAdminDashboardScreen extends StatefulWidget {
  ...
  @override
  State<WardAdminDashboardScreen> createState() => _WardAdminDashboardScreenState();
}
...
class _WardAdminDashboardScreenState extends State<WardAdminDashboardScreen> {
  ...
  Future<String> _requireToken() async {
    ...
    if (token == null || token.trim().isEmpty) throw Exception("Failed to get Firebase token");
    return token;
  }
  ...
  Future<void> _loadDashboard() async {
    ...
    try {
      ...
      if (profileRes.statusCode != 200) {
        throw Exception("Profile load failed: ${profileRes.statusCode} ${profileRes.body}");
      }
      ...
      if (schRes.statusCode != 200) {
        throw Exception("Schedules load failed: ${schRes.statusCode} ${schRes.body}");
      }
      ...
      for (final item in all) {
        ...
        if (myId != null && createdById != null && createdById.toString() == myId.toString()) {
          filtered.add(m);
        }
      }
      ...
      filtered.sort((a, b) {
        final ad =
            DateTime.tryParse((a["scheduleDate"] ?? "").toString()) ?? DateTime.fromMillisecondsSinceEpoch(0);
        final bd =
            DateTime.tryParse((b["scheduleDate"] ?? "").toString()) ?? DateTime.fromMillisecondsSinceEpoch(0);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Dashboard load failed: $e"), backgroundColor: Colors.red),
        );
      }
    } finally {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: _profileImageUrl.isEmpty
                          ? Icon(Icons.person, size: 32.w, color: Colors.blue)
                          : null,
                    ),
                    SizedBox(width: 12.w),
                    Expanded(
                ...
                Text(
                  "Namaste, $displayName",
                  style: GoogleFonts.poppins(fontSize: 26.sp, fontWeight: FontWeight.w700),
                ),
                Text(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.water_drop, size: 40.w, color: Colors.blue),
                        ],
                      ),
                  ...
                  children: [
                    Expanded(
                      child: GestureDetector(
                        onTap: () => AppNavigation.push(context, AppRoutes.newSchedule),
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () => AppNavigation.push(context, AppRoutes.sendNotice),
                        child: _buildQuickActionCard(
                ...
                if (_mySchedules.isEmpty)
                  ...
                  ..._mySchedules.take(5).map((s) {
                    final ward = s["ward"];
                    final wardName =
                        (ward is Map ? ward["wardName"] : null)?.toString() ?? "Ward";
                    ...
                    final dateStr = scheduleDate != null ? _dateYMD(scheduleDate) : "—";
  ...
  Widget _buildQuickActionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20.r),
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 10, offset: Offset(0, 4.h)),
        ],
      ),
      child: Column(
        children: [
  ...
  Widget _buildUpdateCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16.r),
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 8, offset: Offset(0, 2.h)),
        ],
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(time, style: GoogleFonts.poppins(fontSize: 12.sp, color: Colors.grey[600])),
                SizedBox(height: 4.h),
                Text(subtitle,
