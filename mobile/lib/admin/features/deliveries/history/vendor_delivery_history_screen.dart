  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Delivery History', style: GoogleFonts.poppins(fontSize: 20.sp, fontWeight: FontWeight.w600)),
        centerTitle: true,
      ),
      body: ctrl.isLoading
              ...
              children: [
                ...
                Expanded(
                  child: _statCard(
                    ...
                    value: "NPR ${ctrl.stats.totalEarnings.toStringAsFixed(0)}",
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 8.w),
              Text(title, style: GoogleFonts.poppins(fontSize: 12.sp, color: Colors.grey[700])),
            ],
          ),
          SizedBox(height: 12.h),
          Text(value, style: GoogleFonts.poppins(fontSize: 24.sp, fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(d.customerName, style: GoogleFonts.poppins(fontSize: 16.sp, fontWeight: FontWeight.w700)),
                    if (d.address.trim().isNotEmpty)
                      Text(d.address, style: GoogleFonts.poppins(fontSize: 13.sp, color: Colors.grey[700])),
                  ],
                ),
              ),
              Container(
                ...
                child: Text(d.status, style: GoogleFonts.poppins(fontSize: 12.sp, color: statusColor, fontWeight: FontWeight.w600)),
              ),
            ],
          ),
          SizedBox(height: 12.h),
          Row(
            children: [
              Icon(Icons.calendar_today_outlined, size: 16.w, color: Colors.grey[600]),
              SizedBox(width: 6.w),
              Text(
          ...
          Row(
            children: [
              ...
              SizedBox(width: 6.w),
              Text("${d.quantityLiters} L", style: GoogleFonts.poppins(fontSize: 14.sp, color: Colors.grey[800])),
              const Spacer(),
              Text(d.paymentMethod, style: GoogleFonts.poppins(fontSize: 13.sp, color: Colors.grey[700])),
            ],
          ),
        ],
      ),
