...
class DeliveryService {
  static Future<VendorDeliveriesResponse> getVendorDeliveries({int limit = 100}) async {
    final res = await ApiService.get('/vendors/deliveries?limit=$limit');

    if (res.statusCode != 200) {
      throw Exception('GET /vendors/deliveries failed: ${res.statusCode} ${res.body}');
    }

    final data = jsonDecode(res.body) as Map<String, dynamic>;
    final stats = VendorDeliveryStats.fromApi((data['stats'] ?? {}) as Map<String, dynamic>);
